...
class Save extends Action
{
    ...
    public function execute()
    {
        ...
        if (!$this->formKeyValidator->validate($this->getRequest())) {
            ...
            return $resultRedirect->setPath('computergame/index/add');
        }
        ...
        try {
            if ($data) {
                ...
                $this->messageManager->addSuccessMessage(__("Thêm dữ liệu thành công"));
                return $resultRedirect->setPath('computergame/index/index');
            }
        } catch (\Exception $e) {
            $this->messageManager->addErrorMessage($e, __("Gặp lỗi vui lòng thử lại"));
        }
